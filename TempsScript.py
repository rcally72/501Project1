...
def cleanliness():
    badrows = len(kills)
    badpoints = (12*len(datum)) - sum(kills)
    print("Of ", len(datum), "rows, ", badrows, "rows were eliminated due to containing at least one bad datapoint.\n")
    print(badpoints, "datapoints, ", badpoints/(12*len(datum)),"percent of the dataset, were invalid and could not be approximated.")
