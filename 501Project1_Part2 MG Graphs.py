...
# Hypo 1             
# Did temperatures increase faster over time 
# for states with more cars (aka higher vehicle reg numbers)? 
...
dfnew['RangeT'] = dfnew['MaxT'] - dfnew['MinT']
dd = dfnew[['Name','Year','RangeT']]

#Scatter plot of range T vs Car Regs 
    # PCA to ve a 3d plot of rangeT by Car by Year
plt.scatter(dfnew.RangeT,dfnew.Automobiles, c = dfnew.Year)
plt.autumn()
plt.show()

# Create new data set, no missing values & everything numeric
d1 = dfnew[['Automobiles Per Capita','Buses','Trucks','Motorcycles', 'RangeT', 'Year']] 
...
ax.scatter3D(d1.RangeT, d1['Automobiles Per Capita'], d1.Year, c=d1.Year, cmap='hsv')

from sklearn.model_selection import train_test_split 
from sklearn.linear_model import LinearRegression
from sklearn import preprocessing
X = d1[['Automobiles','Buses','Trucks','Motorcycles']].values
Y = d1['RangeT'].values
...
coeff_df = pd.DataFrame(regressor.coef_, ['Automobiles','Buses','Trucks','Motorcycles'], columns=['Coefficient'])  
coeff_df

# Chi Squared Test of Association
from scipy import stats
crosstab = pd.crosstab(dfnew['RangeT'], dfnew['Trucks'])
stats.chi2_contingency(crosstab)

#Granger Causality
d2 = dfnew[['MaxT','MinT','RangeT','Population']] 
...
grangercausalitytests(d2[['MaxT', 'Population']], maxlag=2)
...
#between 2000 and 2010 have higher max temperatures? 

from sklearn import linear_model
df3 = df3.dropna(subset=['MaxT','Percent increase in urban land 2000-2010'])
X = df3[['MaxT', 'RangeT','Population', 'Automobiles','Trucks','Buses','Motorcycles']]
y = df3['Percent increase in urban land 2000-2010']
y = pd.to_numeric(y)
...
#Did states with significant increase of urban land 
#between 2000 and 2010 have more transit ridership?

df3['IncreaseT'] = np.where(df3['MaxT'] > 1.6, 1, 0)
a = df3[df3.IncreaseT == 1]
b = df3[df3.IncreaseT == 0]
a = a['Percent increase in urban land 2000-2010']
a =pd.to_numeric(a)
b = b['Percent increase in urban land 2000-2010'] 
b =pd.to_numeric(b) 
var_a = a.var(ddof=1)
var_b = b.var(ddof=1)
